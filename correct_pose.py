...
def interpolate_trajectory(traj, num_points=40000):
    ...
    # 新的均匀采样点
    new_t = np.linspace(0, 0.7025, num_points)
...
if __name__ == "__main__":
    file_path = "/home/liuwei/mnt/experiment_RAL/MonoGS/traj_livgs0_ori.txt"  # 输入你的TUM轨迹路径
    traj = load_tum_trajectory(file_path)
    new_traj = interpolate_trajectory(traj, num_points=40000)

    # 保存结果
    np.savetxt("/home/liuwei/mnt/experiment_RAL/MonoGS/trajectory_interpolated_hitsz-loop.txt", new_traj, fmt="%.6f")
